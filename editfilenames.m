...
%directions to files
filelocation = 'C:\Users\hwilson23\Documents\UserDataOWS\fluorescein_analysis';
newfolder = 'C:\Users\hwilson23\Documents\UserDataOWS\fluoresceineditednames';
textlocation = 'C:\Users\hwilson23\Documents\UserDataOWS\fluorescein_analysis';
textfilename = 'fluoresceindetails.txt';   
sortlaser = 0; %1 for sorting lasers
...
for a = 1:length(filenames)
    ...
    editedccv = [editedccv; strcat(splitccv(1), '_', string(laserpower(a)), '_', laserlevel(levelindex), '_', splitccv(2), '_', splitccv(3))];
end
...
for b = 1:length(filenames)
    ...
    editedchi = [editedchi; strcat(splitchi(1), '_', string(laserpower(b)), '_', laserlevel(levelindex), '_', splitchi(2), '_', splitchi(3))];
end
...
for c = 1:length(filenames)
    ...
    editedint = [editedint; strcat(splitint(1), '_', string(laserpower(c)), '_', laserlevel(levelindex), '_', splitint(2), '_', splitint(3))];
end
